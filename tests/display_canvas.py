...
terminal.fill(0,0,320,2,terminal.RED)
terminal.fill(0,0,2,170,terminal.RED)
terminal.fill(0,169,320,2,terminal.RED)
terminal.fill(319,0,2,170,terminal.RED)

terminal.update()

terminal.buffer(fbuf,320//2,70,64,32)


terminal.background(0xffff)
